      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-4 py-8 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
        ...
        <div className="mb-8 space-y-5 lg:mb-0 lg:max-w-md">
          ...
          <h1 className="text-[28px] font-semibold leading-tight tracking-tight text-neutral-900 dark:text-zinc-50 sm:text-[32px]">
            ...
            <span className="sm:ml-1">workspace in minutes.</span>
          </h1>
          <p className="max-w-md text-sm text-neutral-600 dark:text-zinc-400">
            Create your KalMatrix workspace and start seeing which epics are
            drifting 2–6 weeks before the dates blow up in steering.
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-4 block lg:hidden">
            ...
            <p className="mt-1 text-xs text-neutral-600 dark:text-zinc-400">
              We’ll create a workspace automatically for now.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="mt-5 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1 h-9 w-full rounded-xl border border-neutral-300 bg-white px-3 text-sm text-neutral-900 
  placeholder:text-neutral-400 focus:border-neutral-500 focus:outline-none 
  dark:border-zinc-700 dark:bg-black/70 dark:text-zinc-100 dark:placeholder:text-zinc-500 
